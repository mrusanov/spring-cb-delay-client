...
ARG CONFIG_SERVER_URL_ARG="http://192.168.99.100:7777"

ARG SERVER_URL_ARG="http://192.168.99.100:8090"
ARG CLIENT_SERVER_READ_TIMEOUT_MILLIS_ARG=5000

ARG HYSTRIX_TIMEOUT_ENABLED_ARG=false
ARG HYSTRIX_TIMEOUT_MILLIS_ARG=1000

ARG HYSTRIX_REQUEST_VOLUME_THRESHOLD_ARG=2
ARG HYSTRIX_SLEEP_WINDOW_MILLIS_ARG=10000
